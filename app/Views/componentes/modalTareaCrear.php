<!-- Modal toggle -->
<button data-modal-target="tarea-modificar-modal" data-modal-toggle="tarea-modificar-modal" class="block text-white font-bold bg-gray-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-blue-800 ml-4" type="button">
    Nueva Tarea
</button>

<!-- Main modal -->
<div id="tarea-modificar-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="tarea-modificar-modal">
            ...
            <!-- Modal body -->
            <?= form_open('modificarTarea', ['id' => 'formModificarTarea', 'class' => 'p-4 md:p-5', 'method' => 'post']) ?>
            <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" name="asunto" id="asunto" value="<?= old('asunto') ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Cumpleaños de Tito" required="">
                ...
                <div class="col-span-2">
                    ...
                    <select id="prioridad" name="prioridad" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        ...
                        <option value="Baja" <?= old('asunto') == 'Baja' ? 'selected' : '' ?>>Baja</option>
                        <option value="Normal" <?= old('asunto') == 'Normal' ? 'selected' : '' ?>>Normal</option>
                        <option value="Alta" <?= old('asunto') == 'Alta' ? 'selected' : '' ?>>Alta</option>
                    </select>
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <input type="date" name="vencimiento" value="<?= old('vencimiento') ?>" id="vencimiento" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="descripcion" value="<?= old('descripcion') ?>" rows="4" maxlength="100" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Este año le preparamos algo especial."></textarea>
                </div>
            </div>
