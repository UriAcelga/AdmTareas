<!-- Modal toggle -->
<img src="<?= base_url('icons/edit.svg') ?>" alt="modificar tarea" class="w-6 h-6 mr-4 cursor-pointer" data-modal-target="tarea-modificar-modal" data-modal-toggle="tarea-modificar-modal">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <input type="date" name="vencimiento" value="<?= esc($fecha_vencimiento) ?>" id="vencimiento" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <input type="date" name="recordatorio" value="<?= esc($fecha_recordatorio) ?>" id="recordatorio" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="descripcion" value="<?= esc($descripcion) ?>" rows="4" maxlength="100" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Este año le preparamos algo especial."></textarea>
                </div>
            </div>
